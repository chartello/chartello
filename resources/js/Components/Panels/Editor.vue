<template>
    <div class="bg-[#f3f3f3] relative flex">
        <div ref="element" v-text="originalValue" class="relative flex-1"/>

        <span v-show="!modelValue" class="absolute top-50 pointer-events-none opacity-[0.15]">Write a query...</span>

        <IconButton @click="store.helpModal.open()" type="button" class="text-gray-400 hover:bg-gray-200">
